...
#SBATCH --output=slurm_output/cd/sbm_wcc/slurm-%j.out
#SBATCH --job-name="cdsbmwcc_modcm_val"
        ...
        do
            ...
            do
                ...
                do
                    ...
                    inp_dir="data/community_detection/${method}/${clustering}/${network_id}/${resolution}/${seed}/sbm/sbm/"
                    ...
                    out_dir="data/community_detection/${method}/${clustering}/${network_id}/${resolution}/${seed}/sbm_wcc/sbm/"
