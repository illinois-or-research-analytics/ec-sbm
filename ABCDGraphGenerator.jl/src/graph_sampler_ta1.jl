struct ABCDParams1
    ...
    function ABCDParams1(w, s, clusters, μ, ξ, isCL, islocal, hasoutliers=false)
...
function populate_clusters_ta1(params::ABCDParams1)
...
function gen_graph_ta1(params::ABCDParams1)
    clusters = populate_clusters_ta1(params)
