...
#SBATCH --job-name="0_all_val_abcd"
...
do
    ...
    do
        ...
        for network_id in cora # $(cat data/networks_train.txt) $(cat data/networks_val.txt) $(cat data/networks_test.txt)
        do
            ...
            for method in abcd #abcd abcdta4 sbm sbmmcspre
            do
