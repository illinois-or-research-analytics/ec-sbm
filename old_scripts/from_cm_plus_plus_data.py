...
for network_id in NETWORK_IDS:
    for r in RS:
        ...
        if not os.path.exists(f'{output_root}/leiden_mod_cm/{network_id}/leiden{r}/edge.dat'):
            print(f'{network_id} {r} S1 not found')

        if not os.path.exists(f'{output_root}/leiden_mod_cm/{network_id}/leiden{r}/com.dat'):
